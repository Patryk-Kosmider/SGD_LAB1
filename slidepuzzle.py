...
def moveCount(moveCount):
    moveCountFont = pygame.font.Font('freesansbold.ttf', 16)
    text = f'Moves: {moveCount}'
    moveSurf = moveCountFont.render(text, True, WHITE)
    moveRect = moveSurf.get_rect()
    moveRect.topleft = (10,40)
